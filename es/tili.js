...
export { clamp, clone, compose, curry, curryN, debounce, defaultTo, defaultsDeep, defer, delay, includes, is, isEmpty, isPlainObject, memoize, merge, omit, path, pick, round, tap, throttle, type, uniqueId, values };
