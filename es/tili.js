...
export { clamp, clone, compose, curry, curryN, debounce, defaultTo, defer, delay, includes, is, isPlainObject, memoize, omit, path, pick, round, tap, throttle, type, uniqueId };
